...
import RicercaUtente from "./anagrafica_components/RicercaUtente";
...
import LogOut from "./anagrafica_components/common/logOut";
dotenv.config();
    ...
    return (
      <div className="App">
        <Switch>
          <Route
            ...
            render={(props) =>
              localStorage.getItem("TOKEN") ? (
                <RicercaUtente
                  {...props}
                  handleRicercaUtente={this.handleRicercaUtente}
                />
              ) : (
                <Redirect
          ...
          <Route
            path={window.defConfigurations.url_prefix + ROUTES.NOT_FOUND}
            exact
